    ...
    <Panel :title="title">
      <el-form label-position="top">
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item label="比赛描述" required>
          ...
          <el-col :span="8">
            <el-form-item label="比赛密码">
              <el-input v-model="contest.password" placeholder="比赛密码"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="24">
            <el-form-item label="允许参赛的IP段">
              <div v-for="(range, index) in contest.allowed_ip_ranges" :key="index">
                <el-row :gutter="20" style="margin-bottom: 15px">
                  <el-col :span="8">
                    <el-input v-model="range.value" placeholder="IP段"></el-input>
                  </el-col>
                  <el-col :span="10">
