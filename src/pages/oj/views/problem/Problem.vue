      ...
      <Card :padding="20" id="submit-code" dis-hover>
        ...
        <Row type="flex" justify="space-between">
          ...
          <div v-else-if="problem.my_status === 0">
            <Alert type="success" show-icon>你已经通过了本题</Alert>
          </div>
          <div v-else-if="this.contestID && !OIContestRealTimePermission && submissionExists">
            <Alert type="success" show-icon>你已经提交了一份代码</Alert>
          </div>
          <div v-if="contestEnded">
            <Alert type="warning" show-icon>比赛已经结束了</Alert>
          </div>
          </Col>
    ...
    <div id="right-column">
      ...
      <Card id="info">
        ...
        <ul>
          ...
          <li>
            <p>由</p>
            <p>{{problem.created_by.username}}创建</p></li>
      ...
      submitCode () {
        ...
        if (this.contestRuleType === 'OI' && !this.OIContestRealTimePermission) {
          if (this.submissionExists) {
            this.$Modal.confirm({
              title: '',
              content: '<h3>你已经提交过了这道题目，确定覆盖？<h3>',
              onOk: () => {
